export const STR = {
  en: {
    ...
    ach_t: 'Achievements', photos_t: 'Campus Photos',
    fav_t: 'Favourites', fav_login: 'Please login first to save favourites',
  ...
  ta: {
    ...
    facilities: 'வளாக வசதிகள்',
    placements: 'வேலைவாய்ப்பு', hostel: 'விடுதி', library: 'நூலகம்', sports: 'விளையாட்டு',
    ach_t: 'சாதனைகள்', photos_t: 'வளாக புகைப்படங்கள்',
    fav_t: 'பிடித்தவை', fav_login: 'பிடித்தவை சேமிக்க முதலில் லாக் இன் செய்யவும்',
