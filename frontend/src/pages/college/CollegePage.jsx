...
function CustomCollegePage({ college, customData }) {
  ...
  return (
    <div className="min-h-screen bg-[#E8E2DB]">
      ...
      {/* Hero - College own images */}
      <div className="relative h-[460px] overflow-hidden bg-[#1A3263]">
        {branding.heroImage ? (
          <img src={branding.heroImage} className="h-full w-full object-cover" alt={`${college.name} Campus`} />
        ) : (
          <div className="h-full w-full bg-gradient-to-br from-[#1A3263] via-[#547792] to-[#1A3263] grid place-items-center">
            <div className="text-center text-white p-8">
              ...
              <div className="text-[12px] text-white/60 mt-4 max-w-[500px]">Add your campus hero image in Admin → Branding → Campus Hero Image</div>
            </div>
          </div>
        )}
