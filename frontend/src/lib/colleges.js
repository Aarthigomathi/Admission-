export const colleges = [
  {
    ...
    alumni: [
      { id: 1, name: 'Vamsikrishnan M', designation: 'Software Development Engineer', company: 'Amazon', companyLogo: 'https://upload.wikimedia.org/wikipedia/commons/a/a9/Amazon_logo.svg', batch: '2019, CSE', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=500&fit=crop', description: 'Building large-scale retail systems at Amazon.' },
      { id: 2, name: 'J Vijay Shankar', designation: 'Engineering Manager', company: 'Microsoft', companyLogo: 'https://upload.wikimedia.org/wikipedia/commons/4/44/Microsoft_logo.svg', batch: '2014, ECE', image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&h=500&fit=crop', description: 'Leading cloud infrastructure teams at Microsoft.' },
      { id: 3, name: 'Meenakshi R', designation: 'Data Scientist', company: 'Google', companyLogo: 'https://upload.wikimedia.org/wikipedia/commons/2/2f/Google_2015_logo.svg', batch: '2018, IT', image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&h=500&fit=crop', description: 'Working on search quality models at Google.' },
      { id: 4, name: 'Karthik Subramanian', designation: 'Senior Consultant', company: 'TCS', companyLogo: 'https://upload.wikimedia.org/wikipedia/commons/5/5e/TCS_Logo_2022.svg', batch: '2012, Mech', image: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400&h=500&fit=crop', description: 'Driving digital transformation programs at TCS.' },
      { id: 5, name: 'Anitha Priya', designation: 'Lead Engineer', company: 'Infosys', companyLogo: 'https://upload.wikimedia.org/wikipedia/commons/9/95/Infosys_logo.svg', batch: '2016, EEE', image: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&h=500&fit=crop', description: 'Leading platform engineering at Infosys.' },
      { id: 6, name: 'Arun Kumar', designation: 'Product Engineer', company: 'Zoho', companyLogo: 'https://upload.wikimedia.org/wikipedia/commons/0/0c/Zoho-logo.svg', batch: '2020, AI-DS', image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=500&fit=crop', description: 'Shipping CRM automation products at Zoho.' },
    ],
    aboutPages: {
      profile: {
        heading: '',
