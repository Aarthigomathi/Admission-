export const colleges = [
  {
    ...
    alumni: [
      { id: 1, name: 'R Suganthraj', designation: 'Software Development Engineer', company: 'Amazon', companyLogo: 'https://upload.wikimedia.org/wikipedia/commons/a/a9/Amazon_logo.svg', batch: '2019, CSE', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=500&fit=crop' },
      { id: 2, name: 'Sarumathi S', designation: 'Software Development Engineer', company: 'Amazon', companyLogo: 'https://upload.wikimedia.org/wikipedia/commons/a/a9/Amazon_logo.svg', batch: '2018, IT', image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&h=500&fit=crop' },
      { id: 3, name: 'H Mohamed Sunfeer', designation: 'Senior Security Software Engineer', company: 'Nvidia', companyLogo: 'https://upload.wikimedia.org/wikipedia/commons/2/21/Nvidia_logo.svg', batch: '2015, ECE', image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&h=500&fit=crop' },
      { id: 4, name: 'Jawahar Ganeshs', designation: 'Technical Advisor', company: 'Microsoft', companyLogo: 'https://upload.wikimedia.org/wikipedia/commons/4/44/Microsoft_logo.svg', batch: '2012, Mech', image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=500&fit=crop' },
      { id: 5, name: 'Kaarthic Manickam', designation: 'Engineering Manager', company: 'Meta', companyLogo: 'https://upload.wikimedia.org/wikipedia/commons/7/7b/Meta_Platforms_Inc._logo.svg', batch: '2011, EEE', image: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400&h=500&fit=crop' },
      { id: 6, name: 'Vignesh Sukumar', designation: 'Senior Software Engineer', company: 'Meta', companyLogo: 'https://upload.wikimedia.org/wikipedia/commons/7/7b/Meta_Platforms_Inc._logo.svg', batch: '2016, CSE', image: 'https://images.unsplash.com/photo-1501196354995-dbb39b5c5311?w=400&h=500&fit=crop' },
      { id: 7, name: 'Sivakumar A', designation: 'Principal Member', company: 'Oracle', companyLogo: 'https://upload.wikimedia.org/wikipedia/commons/5/50/Oracle_logo.svg', batch: '2009, IT', image: 'https://images.unsplash.com/photo-1504257432389-52343af06ae3?w=400&h=500&fit=crop' },
      { id: 8, name: 'J Vijay Shankar', designation: 'Software Development Engineer', company: 'Amazon', companyLogo: 'https://upload.wikimedia.org/wikipedia/commons/a/a9/Amazon_logo.svg', batch: '2020, AI-DS', image: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&h=500&fit=crop' },
      { id: 9, name: 'Vamsikrishnan M', designation: 'Software Development Engineer', company: 'Amazon', companyLogo: 'https://upload.wikimedia.org/wikipedia/commons/a/a9/Amazon_logo.svg', batch: '2019, CSE', image: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=400&h=500&fit=crop' },
      { id: 10, name: 'Mohammed Javid', designation: 'Software Engineer', company: 'BMW', companyLogo: 'https://upload.wikimedia.org/wikipedia/commons/4/44/BMW.svg', batch: '2017, Auto', image: 'https://images.unsplash.com/photo-1547425265-710a49547608?w=400&h=500&fit=crop' },
    ],
    aboutPages: {
      profile: {
        heading: '',
